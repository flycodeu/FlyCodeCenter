...
- 近似数值：FLOAT/DOUBLE（允许误差的场景）
  官方数据类型总览：[MySQL 数据类型](https://dev.mysql.com/doc/refman/8.0/en/data-types.html)
...
MySQL 日期时间类型官方定义见手册：[MySQL 日期时间类型](https://dev.mysql.com/doc/refman/8.0/en/date-and-time-types.html)  
常用原则：
...
官方 SELECT 语法是所有查询能力的基座：[MySQL SELECT 语法](https://dev.mysql.com/doc/refman/8.0/en/select.html)
